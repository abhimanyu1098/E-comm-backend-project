...
public class RestClientConfig {
    ...
    private ObservationRegistry  observationRegistry; // This helps collect metrics and trace data

    @Autowired(required = false)
    private Tracer tracer;          // This capture trace and span ID

    @Autowired(required = false)
    private Propagator propagator; // This inject the trace context headers into outgoing Http request
