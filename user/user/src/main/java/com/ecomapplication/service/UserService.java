...
import com.ecomapplication.model.Address;
import com.ecomapplication.model.User;
...
public class UserService {
    ...
    public Optional<UserResponse> fetchId(String id) {
        return userRepository.findById(String.valueOf(id)).map(this::mapToUserResponse);

    }

    public boolean update(String id,UserRequest updateUserRequest) {
